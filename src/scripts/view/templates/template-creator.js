function mainPages(containerName) {
  return `
    <section class="w-full flex flex-col items-center bg-slate-50 h-auto py-2 md:py-0 md:h-72" id="hero">
    </section>
    <section class="w-full py-8 flex justify-center">
        <div class="w-full max-w-[1500px] flex flex-col md:flex-row gap-8 px-4">
