class PartnerBreadcrumbsTransaction extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML += `
      <div id="breadcrumbs-transaction" class="flex flex-row gap-2">
        <a href="#/partner/dashboard" class="text-lime-700">Dashboard</a>
        ...
        <a href="#/partner/dashboard/buying-transaction" class="text-lime-700">Pembelian</a>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
...
customElements.define('partner-breadcrumbs-transaction', PartnerBreadcrumbsTransaction);
