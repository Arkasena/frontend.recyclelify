class DashboardMenuTabSellingTransaction extends HTMLElement {
  constructor() {
    super();
    this._menuTabData = [
...
customElements.define('dashboard-menu-tab-selling-transaction', DashboardMenuTabSellingTransaction);
