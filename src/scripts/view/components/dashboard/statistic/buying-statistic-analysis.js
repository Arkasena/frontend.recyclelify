    ...
    this.innerHTML += `
      <div id="statistic-alaysis">
        <div id="statistic-container h-full">
            ...
            <p id="subheadertext-analysis" >Dengan membeli ${this.statisticAnalysisData.total_weight} kg sampah plastik, Anda telah berkontribusi besar dalam menjaga kebersihan lingkungan. Angka ini setara dengan : </p>
