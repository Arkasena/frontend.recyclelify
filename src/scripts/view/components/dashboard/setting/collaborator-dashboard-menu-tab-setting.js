class CollaboratorDashboardMenuTabSetting extends HTMLElement {
  constructor() {
    super();
    this._menuTabData = [
...
customElements.define('collaborator-dashboard-menu-tab-setting', CollaboratorDashboardMenuTabSetting);
