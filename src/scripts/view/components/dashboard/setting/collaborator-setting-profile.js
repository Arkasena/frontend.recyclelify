    ...
    this.innerHTML = `
      <div id="profile-setting" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col pb-4 w-full">
          ...
          <input class="rounded-lg outline-lime-600 relative border-0 text-base w-full h-16 shadow-md px-3" type="tel" name="phone" id="phone" placeholder="Nomor Telpon" value="${this.settingProfileData.province}" required>
        </div>
